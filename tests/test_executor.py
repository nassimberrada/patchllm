...
def test_execute_step_with_text_only(mock_run_llm_query):
    ...
    mock_run_llm_query.return_value = "<file_path:/a.txt>\n```\n...```"
    
    execute_step("test instruction", [], "test context", None, "gemini/gemini-1.5-flash")
...
def test_execute_step_with_images(mock_run_llm_query):
    ...
    execute_step("test instruction", [], "test context", mock_image_data, "gemini/gemini-1.5-flash")
